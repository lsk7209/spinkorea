      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white/5 border border-white/10 rounded-2xl p-8 md:p-12">
          ...
          <p className="text-gray-300 leading-relaxed text-lg mb-6">
            현대인은 하루에 약 <strong className="text-white">35,000번</strong>
            의 결정을 내린다고 합니다. 점심 메뉴 선택부터 중요한 업무 결정까지,
            끊임없는 선택의 연속 속에서 우리의 뇌는 지쳐갑니다.
          </p>
          <p className="text-gray-300 leading-relaxed text-lg">
            ...
            를 줄여드리기 위해 탄생했습니다. 사소한 결정은 운에 맡기고, 정말
            중요한 일에 에너지를 집중하세요.
          </p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:border-neon-primary/50 transition-colors">
            ...
            <p className="text-gray-400 text-sm">
              점심 메뉴, 벌칙 정하기, 당첨자 추첨 등 다양한 상황에서 공정한 랜덤
              선택을 제공합니다.
            </p>
          </div>
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:border-neon-secondary/50 transition-colors">
            ...
            <p className="text-gray-400 text-sm">
              BMI 계산기, 비밀번호 생성기, 글자수 세기 등 일상에 유용한 24개
              이상의 무료 도구를 제공합니다.
            </p>
          </div>
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:border-aurora-accent/50 transition-colors">
            ...
            <p className="text-gray-400 text-sm">
              결정 심리학, 생산성 팁, 건강 관리 가이드 등 유용한 정보를
              공유합니다.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  모든 서비스는 무료로 제공되며, 회원가입 없이 바로 이용
                  가능합니다.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  필요 이상의 개인정보를 수집하지 않으며, 모든 데이터는 안전하게
                  처리됩니다.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  PC, 태블릿, 모바일 어디서든 최적화된 경험을 제공합니다.
                </p>
              </div>
            </div>
          </div>
