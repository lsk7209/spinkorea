...
export default function ToolsIndex() {
    return (
        <div className="min-h-[100dvh] bg-aurora-bg pt-20 pb-20">
            <SEO
                title="무료 유틸리티 모음 43종 | SpinFlow — 계산기·변환·랜덤 도구"
                description="연봉 실수령액·할인율·더치페이·속도·부가세·평수·마진·날짜 계산기, 시급·대출·복리·퇴직금 계산기, 로또, QR 코드, 글자수, JSON 포맷터 등 43가지 무료 웹 도구를 한 곳에서 사용하세요."
