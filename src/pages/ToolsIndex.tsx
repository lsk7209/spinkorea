...
export default function ToolsIndex() {
    return (
        <div className="min-h-[100dvh] bg-aurora-bg pt-20 pb-20">
            <SEO
                title="무료 유틸리티 모음 36종 | SpinFlow — 계산기·변환·랜덤 도구"
                description="연봉 실수령액·부가세·시급·대출·복리·퇴직금·연차 계산기, 로또, QR 코드, 글자수, JSON 포맷터 등 36가지 무료 웹 도구를 한 곳에서 사용하세요. 설치 없이 바로 이용 가능."
