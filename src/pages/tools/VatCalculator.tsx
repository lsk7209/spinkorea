...
export default function VatCalculator() {
  ...
  return (
    <ToolLayout
      ...
      sources={[{ name: "국세청 부가가치세 안내", url: "https://www.nts.go.kr/nts/cm/cntnts/cntntsView.do?cntntsId=7703&mi=2271" }]}
      reviewedAt="2026-08-28"
      disclaimer="일반적인 10% 세율을 단순 계산한 참고값입니다. 영세율·면세·업종별 처리와 신고 금액은 국세청 안내 또는 세무 전문가에게 확인하세요."
      howToUse={[
