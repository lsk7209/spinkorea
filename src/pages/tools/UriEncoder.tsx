...
export default function UriEncoder() {
  ...
  return (
    <ToolLayout
      ...
      howToUse={[
        "인코딩 또는 디코딩할 URL/텍스트를 입력하세요.",
        "'인코딩' 또는 '디코딩' 버튼을 클릭하세요.",
        "결과를 복사하세요.",
      ]}
      faqs={[
        {
          question: "URL 인코딩이 왜 필요한가요?",
          answer:
            "URL에는 영문자, 숫자, 일부 특수문자만 사용할 수 있습니다. 한글, 공백, 특수문자는 %XX 형식으로 인코딩해야 올바르게 동작합니다.",
        },
        {
          question: "encodeURI와 encodeURIComponent의 차이는?",
          answer:
            "encodeURI는 URL 전체를 인코딩하며 ://?=& 등은 유지합니다. encodeURIComponent는 URL 구성 요소를 인코딩하며 특수문자도 모두 변환합니다.",
        },
      ]}
      relatedTools={[
        {
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 items-start relative">
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea
              ...
              placeholder={
                mode === "encode"
                  ? "변환할 텍스트를 입력하세요 (예: 한글)"
                  : "디코딩할 URL을 입력하세요 (예: %ED%95%9C%EA%B8%80)"
              }
          ...
          <div className="flex flex-col gap-2 relative">
            ...
            <textarea
              ...
              className={`w-full h-64 bg-black/40 border rounded-xl p-4 text-sm font-mono leading-relaxed focus:outline-none resize-none ${
                error
        ...
        <div className="bg-white/5 border border-white/10 p-5 rounded-xl mt-4">
          ...
          <p className="text-sm text-gray-400 leading-relaxed">
            ...
            한글이나 공백, 특수문자 등을 URL에 포함시키려면{" "}
            <strong>퍼센트 인코딩(Percent-Encoding)</strong>이라는 방식으로
            변환해주어야 합니다. 이 도구는 자바스크립트의 표준{" "}
            <code className="bg-black/30 px-1 rounded text-gray-300">
              encodeURIComponent
            </code>{" "}
            함수를 사용하여 모든 브라우저와 호환되는 결과를 제공합니다.
          </p>
        </div>
      </div>
    </ToolLayout>
