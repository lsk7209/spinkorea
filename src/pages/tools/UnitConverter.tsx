...
export default function UnitConverter() {
  ...
  return (
    <ToolLayout
      ...
      howToUse={[
        "변환할 단위 카테고리를 선택하세요 (길이, 무게, 온도, 부피 등).",
        "변환할 값을 입력하세요.",
        "원본 단위와 목표 단위를 선택하세요.",
        "변환 결과를 확인하세요.",
      ]}
      faqs={[
        {
          question: "어떤 단위를 지원하나요?",
          answer:
            "길이(km, m, cm, inch, feet, mile), 무게(kg, g, lb, oz), 온도(°C, °F, K), 부피(L, mL, gallon) 등 일상에서 자주 사용하는 단위를 지원합니다.",
        },
        {
          question: "온도 변환 공식은 무엇인가요?",
          answer:
            "°C → °F: (°C × 1.8) + 32, °F → °C: (°F - 32) ÷ 1.8입니다. 켈빈(K) = °C + 273.15입니다.",
        },
      ]}
      relatedTools={[
        {
