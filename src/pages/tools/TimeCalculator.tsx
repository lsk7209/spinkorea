  ...
  return (
    <ToolLayout
      ...
      howToUse={[
        "시작 시간을 입력하세요.",
        "종료 시간을 입력하세요.",
        "시간 차이가 시·분·초로 자동 계산됩니다.",
        "시간 더하기/빼기도 가능합니다.",
      ]}
      faqs={[
        {
          question: "날짜를 넘기는 계산도 가능한가요?",
          answer:
            "네, 자정을 넘기는 경우도 정확하게 계산됩니다. 예를 들어 22:00부터 다음날 08:00까지의 시간도 계산됩니다.",
        },
        {
          question: "근무 시간 계산에 활용할 수 있나요?",
          answer:
            "네, 출근 시간과 퇴근 시간을 입력하면 정확한 근무 시간이 계산됩니다. 휴게 시간을 뺀 실제 근무 시간도 계산해보세요.",
        },
      ]}
      relatedTools={[
        {
        ...
        },
        {
          ...
          description: "날짜 ↔ 타임스탬프",
        },
        {
          name: "퍼센트 계산기",
          path: "/tools/percentage-calculator",
          description: "비율·할인율 계산",
        },
      ]}
    >
      <div className="flex flex-col gap-8 max-w-2xl mx-auto">
        ...
        <div className="bg-white/5 border border-white/10 p-6 rounded-xl relative overflow-hidden">
          ...
          <div className="mt-6 text-center bg-black/20 p-4 rounded-lg border border-white/5">
            ...
            <span className="text-3xl font-bold text-white block md:inline mt-1 md:mt-0">
              {diffResult}
            </span>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-4">
              <div className="flex-1">
                ...
                />
                <span className="block text-center text-gray-500 text-xs mt-1">
                  시간
                </span>
              </div>
              <div className="flex-1">
            ...
            <div className="mt-4 text-center bg-black/20 p-4 rounded-lg border border-white/5">
              ...
              <span
                className={`text-3xl font-bold block md:inline mt-1 md:mt-0 ${calcType === "add" ? "text-neon-secondary" : "text-red-400"}`}
              >
                {calcResult}
              </span>
            </div>
