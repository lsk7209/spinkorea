...
export default function LoremIpsum() {
  ...
  return (
    <ToolLayout
      ...
      howToUse={[
        "생성할 단락(Paragraph) 수를 설정하세요.",
        "'생성하기' 버튼을 클릭하세요.",
        "생성된 더미 텍스트를 복사하세요.",
      ]}
      faqs={[
        {
          question: "로렘 입숨(Lorem Ipsum)이란 무엇인가요?",
          answer:
            "UI/UX 디자인, 출판물 레이아웃 작업 시 실제 콘텐츠 대신 사용하는 더미 텍스트입니다. 텍스트 자체보다 레이아웃에 집중할 수 있게 해줍니다.",
        },
        {
          question: "상업적으로 사용해도 되나요?",
          answer:
            "네, 로렘 입숨 텍스트는 저작권이 없으며 어떤 프로젝트에도 자유롭게 사용 가능합니다.",
        },
      ]}
      relatedTools={[
        {
          ...
          description: "글자수 실시간 확인",
        },
        {
          name: "대소문자 변환",
          path: "/tools/case-converter",
          description: "텍스트 케이스 변환",
        },
        {
          name: "마크다운 미리보기",
        ...
        <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4 flex items-start gap-3">
          ...
          <div className="text-sm">
            <h4 className="text-blue-300 font-bold mb-1">
              로렘 입숨(Lorem Ipsum)이란?
            </h4>
            <p className="text-gray-400 leading-relaxed">
              출판이나 그래픽 디자인 분야에서 폰트, 타입페이스, 레이아웃 같은
              그래픽 요소나 시각적 연출을 보여줄 때 사용하는 표준 채움글입니다.
              키케로의 "최고선악론"에서 유래되었으며, 의미 없는 라틴어 문장들로
              구성되어 있어 디자인 자체에 집중할 수 있게 도와줍니다.
            </p>
          </div>
        </div>
      </div>
