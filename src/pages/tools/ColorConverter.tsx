...
export default function ColorConverter() {
  ...
  return (
    <ToolLayout
      ...
      howToUse={[
        "HEX, RGB, HSL 중 한 가지 형식으로 색상값을 입력하세요.",
        "다른 형식의 변환 결과가 자동으로 표시됩니다.",
        "색상 미리보기를 확인하세요.",
      ]}
      faqs={[
        {
          question: "HEX, RGB, HSL의 차이는 무엇인가요?",
          answer:
            "HEX는 #RRGGBB 형식으로 CSS에서 가장 많이 사용됩니다. RGB는 빨강·초록·파랑 값(0~255)으로 표현합니다. HSL은 색조·채도·밝기로 표현하여 색상 조절이 직관적입니다.",
        },
        {
          question: "알파(투명도) 값도 변환되나요?",
          answer:
            "네, RGBA와 HSLA 형식도 지원하여 투명도(0~1)를 포함한 변환이 가능합니다.",
        },
      ]}
      relatedTools={[
        {
          ...
          description: "Box shadow 시각화",
        },
        {
          name: "QR 코드 생성",
          path: "/tools/qr-code-generator",
          description: "색상 커스텀 QR 생성",
        },
        {
          name: "마크다운 미리보기",
          path: "/tools/markdown-previewer",
          description: "MD 실시간 렌더링",
        },
      ]}
    >
          ...
          <div className="bg-white/5 border border-white/10 p-5 rounded-xl">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="w-full bg-black/30 border border-white/20 rounded-lg px-2 py-2 text-white font-mono text-center focus:border-red-500 focus:outline-none"
                placeholder="R"
              />
              <input
                type="number"
                ...
                className="w-full bg-black/30 border border-white/20 rounded-lg px-2 py-2 text-white font-mono text-center focus:border-green-500 focus:outline-none"
                placeholder="G"
              />
              <input
                type="number"
                ...
                className="w-full bg-black/30 border border-white/20 rounded-lg px-2 py-2 text-white font-mono text-center focus:border-blue-500 focus:outline-none"
                placeholder="B"
              />
            </div>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 p-5 rounded-xl">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="w-full bg-black/30 border border-white/20 rounded-lg px-2 py-2 text-white font-mono text-center focus:border-neon-secondary focus:outline-none"
                placeholder="H"
              />
              <input
                type="number"
