...
const faqData: FAQItem[] = [
  ...
  // 유틸리티 도구
  {
    ...
    answer: "총 33개 이상의 무료 도구를 제공합니다. 랜덤(로또·주사위·동전), 텍스트·개발(글자수·JSON·Base64·QR), 계산기(BMI·퍼센트·나이·단위), 날짜·시간(타이머·D-Day), 생활 금융(시급·대출·전월세·복리·퇴직금·연차·실수령액 계산기) 카테고리로 구성되어 있습니다.",
  },
  {
    category: "유틸리티 도구",
