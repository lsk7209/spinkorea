...
const faqData: FAQItem[] = [
  ...
  // 유틸리티 도구
  {
    ...
    answer: "총 49개 무료 도구를 제공합니다. 랜덤(로또·주사위·동전), 텍스트·개발(글자수·JSON·Base64·QR·진법변환·UUID), 계산기(나이·퍼센트·시간·단위·평수·마진·할인율·속도·연비·통계), 건강·피트니스(BMI·칼로리·체지방률·수면·칼로리소모·수분섭취·이상체중), 날짜·시간(날짜·타이머·D-Day), 생활 금융(시급·대출·전월세·복리·퇴직금·연차·실수령액·부가세·더치페이) 카테고리로 구성되어 있습니다.",
  },
  {
    category: "유틸리티 도구",
