...
- [x] **Infrastructure Setup**
  ...
  - [x] Run DB Migration `npm run db:migrate`
- [x] **Performance & Quality**
  - [x] Implement Dynamic Import for `canvas-confetti`
  - [x] Fix Lint warnings & Unused code
  - [x] Add Toast Notification (replace `alert`)
- [x] **SEO & Analytics**
